...
Example usage:
http://localhost:3131/user/login?username=noonlord23&password=testpass
...
Example usage:
http://localhost:3131/user/getUsername?id=13
...
Example usage:
http://localhost:3131/guild/data?guildId=4
...
Example usage:
http://localhost:3131/channel/guildChannels?guildId=4
...
Example usage:
http://localhost:3131/connections/getGuildMembers?guildId=123
...
http://localhost:3131/message/getMessages?channelId=4

Example usage with after parameter (UNIX time):
http://localhost:3131/message/getMessages?channelId=4&after=1640576468
